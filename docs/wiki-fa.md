...
- **ناوبری مبتنی بر نقش**: کاربران SUPER_ADMIN، ADMIN، WORKER و CUSTOMER بخش‌های متفاوتی می‌بینند. دسترسی ادمین بر اساس آرایهٔ permissions بازگشتی از بک‌اند کنترل می‌شود.
...
- **دعوت ادمین‌ها**: صفحات مدیریت ادمین به کاربران مجاز اجازه می‌دهد ادمین‌های دیگر را با ایمیل دعوت کنند و سطح دسترسی آن‌ها را تنظیم کنند. ارسال ایمیل برای تنظیم رمز بر عهدهٔ بک‌اند است.
...
- **Admin**: وارد می‌شود، فقط بخش‌های ادمین متناسب با permissions خود را می‌بیند و می‌تواند ادمین‌های دیگر را مدیریت یا دعوت کند.
- **Super Admin**: وارد می‌شود و به `/super-admin` و ابزارهای نظارتی مرتبط دسترسی دارد بدون آن‌که هیچ اعتبار از پیش تعیین‌شده‌ای در فرانت‌اند وجود داشته باشد.
