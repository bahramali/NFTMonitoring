...
const emptyVariant = () => ({ id: null, localId: globalThis.crypto?.randomUUID?.() || `new-${Date.now()}`, weight: '', price: '', stock: '', sku: '', imageUrl: '', active: true, tierPrices: {} });
...
export default function ProductAdmin() {
    ...
    const activeEditorVariantImageUrl = normalizeUrl(activeEditorVariant?.imageUrl);
