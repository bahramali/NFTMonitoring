...
import SensorDashboard from '../src/features/dashboard/SensorDashboard';
...
vi.mock('../src/features/dashboard/TopicSection', () => ({ default: () => <div /> }));
vi.mock('../src/features/dashboard/NotesBlock', () => ({ default: () => <div /> }));
